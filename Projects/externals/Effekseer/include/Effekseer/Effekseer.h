...
public:
	...
	virtual bool Equal([[maybe_unused]]const RenderingUserData* rhs) const
	{
		return true;
	}
};
...
public:
	...
	/**
		...
		@return	VertexBuffer
	*/
	virtual VertexBufferRef CreateVertexBuffer([[maybe_unused]]int32_t size, [[maybe_unused]] const void* initialData, [[maybe_unused]] bool isDynamic)
	{
	...
	/**
		...
		@return	IndexBuffer
	*/
	virtual IndexBufferRef CreateIndexBuffer([[maybe_unused]] int32_t elementCount, [[maybe_unused]] const void* initialData, [[maybe_unused]] IndexBufferStrideType stride)
	{
	...
	*/
	virtual bool UpdateVertexBuffer([[maybe_unused]] VertexBufferRef& buffer, [[maybe_unused]] int32_t size, [[maybe_unused]] int32_t offset, [[maybe_unused]] const void* data)
	{
		return false;
	}
	...
	/**
		...
		@return	Succeeded in updating?
	*/
	virtual bool UpdateIndexBuffer([[maybe_unused]] IndexBufferRef& buffer, [[maybe_unused]] int32_t size, [[maybe_unused]] int32_t offset, [[maybe_unused]] const void* data)
	{
		return false;
	}
	...
	/**
		...
		@return	Succeeded in updating?
	*/
	virtual bool UpdateUniformBuffer([[maybe_unused]] UniformBufferRef& buffer, [[maybe_unused]] int32_t size, [[maybe_unused]] int32_t offset, [[maybe_unused]] const void* data)
	{
		return false;
	}
	...
	*/
	virtual VertexLayoutRef CreateVertexLayout([[maybe_unused]] const VertexLayoutElement* elements, [[maybe_unused]] int32_t elementCount)
	{
	...
	*/
	virtual UniformBufferRef CreateUniformBuffer([[maybe_unused]] int32_t size, [[maybe_unused]] const void* initialData)
	{
		return UniformBufferRef{};
	}

	virtual PipelineStateRef CreatePipelineState([[maybe_unused]] const PipelineStateParameter& param)
	{
		return PipelineStateRef{};
	}

	virtual FrameBufferRef CreateFrameBuffer([[maybe_unused]] const TextureFormatType* formats, [[maybe_unused]] int32_t formatCount, [[maybe_unused]] TextureFormatType depthFormat)
	{
		return FrameBufferRef{};
	}

	virtual RenderPassRef CreateRenderPass([[maybe_unused]] FixedSizeVector<TextureRef, RenderTargetMax>& textures, [[maybe_unused]] TextureRef& depthTexture)
	{
		return RenderPassRef{};
	}

	virtual TextureRef CreateTexture([[maybe_unused]] const TextureParameter& param, [[maybe_unused]] const CustomVector<uint8_t>& initialData = CustomVector<uint8_t>())
	{
		return TextureRef{};
	}

	virtual TextureRef CreateRenderTexture([[maybe_unused]] const RenderTextureParameter& param)
	{
		return TextureRef{};
	}

	virtual TextureRef CreateDepthTexture([[maybe_unused]] const DepthTextureParameter& param)
	{
		return TextureRef{};
	}

	virtual bool CopyTexture([[maybe_unused]] TextureRef& dst, [[maybe_unused]] TextureRef& src, [[maybe_unused]] const std::array<int, 3>& dstPos, [[maybe_unused]] const std::array<int, 3>& srcPos, [[maybe_unused]] const std::array<int, 3>& size, [[maybe_unused]] int32_t dstLayer, [[maybe_unused]] int32_t srcLayer)
	{
		return false;
	}
	...
	/**
		...
		@return	Shader
	*/
	virtual ShaderRef CreateShaderFromKey([[maybe_unused]] const char* key)
	{
		return ShaderRef{};
	}

	virtual ShaderRef CreateShaderFromCodes([[maybe_unused]] const CustomVector<StringView<char>>& vsCodes, [[maybe_unused]] const CustomVector<StringView<char>>& psCodes, [[maybe_unused]] UniformLayoutRef layout = nullptr)
	{
		return ShaderRef{};
	}

	virtual ShaderRef CreateShaderFromBinary([[maybe_unused]] const void* vsData, [[maybe_unused]] int32_t vsDataSize, [[maybe_unused]] const void* psData, [[maybe_unused]] int32_t psDataSize)
	{
		return ShaderRef{};
	}
	...
	*/
	...
	virtual void Draw([[maybe_unused]] const DrawParameter& drawParam)
	{
	}

	virtual void SetViewport([[maybe_unused]] int32_t x, [[maybe_unused]] int32_t y, [[maybe_unused]] int32_t width, [[maybe_unused]] int32_t height)
	{
	}

	virtual void BeginRenderPass([[maybe_unused]] RenderPassRef& renderPass, [[maybe_unused]] bool isColorCleared, [[maybe_unused]] bool isDepthCleared, [[maybe_unused]] Color clearColor)
	{
	}
