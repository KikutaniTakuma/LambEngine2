...
public:
	...
	virtual void BeginRendering([[maybe_unused]] const NodeParameter& parameter, [[maybe_unused]] int32_t count, [[maybe_unused]] void* userData)
	{
	}

	virtual void Rendering([[maybe_unused]] const NodeParameter& parameter, [[maybe_unused]] const InstanceParameter& instanceParameter, [[maybe_unused]] void* userData)
	{
	}

	virtual void EndRendering([[maybe_unused]] const NodeParameter& parameter, [[maybe_unused]] void* userData)
	{
	}
};
...
public:
	...
	virtual void BeginRenderingGroup([[maybe_unused]] const NodeParameter& parameter, [[maybe_unused]] int32_t count, [[maybe_unused]] void* userData)
	{
	}

	virtual void EndRenderingGroup([[maybe_unused]] const NodeParameter& parameter, [[maybe_unused]] int32_t count, [[maybe_unused]] void* userData)
	{
	}
};
...
public:
	...
	*/
	virtual TextureRef Load([[maybe_unused]] const void* data, [[maybe_unused]] int32_t size, [[maybe_unused]] TextureType textureType, [[maybe_unused]] bool isMipMapEnabled)
	{
		return nullptr;
	}
	...
	*/
	virtual void Unload([[maybe_unused]] TextureRef data)
	{
	}
};
...
public:
	...
	*/
	...
	/**
		...
		\~Japanese	読み込まれたマテリアルのポインタ
	*/
	virtual MaterialRef Load([[maybe_unused]] const void* data, [[maybe_unused]] int32_t size, [[maybe_unused]] MaterialFileType fileType)
	{
		return nullptr;
	}
	...
	/**
		...
		\~Japanese	読み込まれたマテリアルのポインタ
	*/
	virtual void Unload([[maybe_unused]] MaterialRef data)
	{
	}
};
...
public:
	...
	Curve(const void* data, int32_t size)
	{
		...
		memcpy(&converter_version, (void*)p, sizeof(int32_t));
		p += sizeof(int32_t);
...
public:
	...
	*/
	virtual SoundDataRef Load([[maybe_unused]] const void* data, [[maybe_unused]] int32_t size)
	{
		return nullptr;
	}
