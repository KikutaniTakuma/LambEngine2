...
namespace Lamb {
	...
	public:
		...
		Mat4x4 Get(const Mat4x4& start, const Mat4x4& end) {
			return Mat4x4::Lerp(start, end, GetTypeT());
		}

		Quaternion Get(const Quaternion& start, const Quaternion& end) {
			return Quaternion::Slerp(start, end, GetTypeT());
		}
